...
RSpec.describe 'users/show.html.erb', type: :feature do
  describe 'show page' do
    ...
    let!(:post2) { Post.create(user:, title: 'Post 2', text: 'This is my second post', author_id: 2) }
    let!(:post3) { Post.create(user:, title: 'Post 3', text: 'This is my third post', author_id: 3) }
